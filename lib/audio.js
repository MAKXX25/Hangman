...
// ── 2. Natural, Emotional Human TTS Engine for Dialogues ─────────────────────
// Uses authentic human vocal range (base 1.00 pitch) with contextual emotional modulation
export function speakDialogue(rawText, options = {}) {
  ...
  try {
    ...
    // Dynamic Human Emotional Prosody (Pitch & Rate calibrated for natural neural voices)
