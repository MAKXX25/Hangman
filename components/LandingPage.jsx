  ...
  return (
    <div className="min-h-screen bg-[#0a0a10] text-slate-100 font-sans selection:bg-purple-500 selection:text-white relative overflow-x-hidden">
      ...
      <header className="relative w-full flex items-center justify-between px-6 py-4 bg-[#09090b] border-b border-white/5 z-50">
        ...
        {/* Left: Brand Logo */}
        <a href="#" className="inline-flex items-center gap-3 group select-none z-10" aria-label="Hangman Duel Home">
      ...
      <section id="hero" className="relative z-10 pt-16 pb-24 md:pt-24 md:pb-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* Subheadline */}
          <p className="max-w-3xl mx-auto text-sm sm:text-base md:text-lg text-slate-300 font-normal leading-relaxed mb-10">
